...
data = dict(
    ...
    train=[
        dict(
            ...
            # # VATrack joint training on SAIL-VOScut (amo bbox, amo+vis mask)
            ann_file="../data/sailvos_cut_json/joint/train(bbox=amdl_bbox).json",
    ...
    val=dict(
        ...
        # # VATrack joint validation on SAIL-VOScut (amo bbox, amo+vis mask)
        ann_file="../data/sailvos_cut_json/joint/valid(bbox=amdl_bbox).json",
        img_prefix='../data/sailvos_cut_png/',
    ...
    test=dict(
        type='SAILVOSVideoDataset',
        # # VATrack joint testing on SAIL-VOScut (amo bbox, amo+vis mask)
        ann_file="../data/sailvos_cut_json/joint/valid(bbox=amdl_bbox).json",
        img_prefix='../data/sailvos_cut_png/',
