...
data_root = '../data/sailvos_complete_video/'             # path to SAILVOScut
img_norm_cfg = dict(
...
data = dict(
    ...
    train=[
        dict(
            ...
            ann_file="../data/sailvos_complete_json/amodal/train.json",
    ...
    val=dict(
        ...
        ann_file="../data/sailvos_complete_json/amodal/valid.json",
        img_prefix='../data/sailvos_complete_png/',
