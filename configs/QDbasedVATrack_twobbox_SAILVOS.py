...
data = dict(
    ...
    train=[
        dict(
            ...
            # # VATrack with 2 bbox heads joint training on SAIL-VOS (amo+vis bbox, amo+vis mask) (contains abrupt scene change)
            ann_file="../data/sailvos_complete_json/joint/train(bbox=both_bbox).json",
    ...
    val=dict(
        ...
        # #VATrack with 2 bbox heads joint validation on SAIL-VOS (amo+vis bbox, amo+vis mask)
        ann_file="../data/sailvos_complete_json/joint/valid(bbox=both_bbox).json",
        img_prefix='../data/sailvos_complete_png/',
    ...
    test=dict(
        ...
        # # VATrack with 2 bbox heads joint testing on SAIL-VOS (amo+vis bbox, amo+vis mask)
        ann_file="../data/sailvos_complete_json/joint/valid(bbox=both_bbox).json",
        img_prefix='../data/sailvos_complete_png/',
