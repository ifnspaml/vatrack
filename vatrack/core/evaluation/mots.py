...
def eval_mots(api, anns, all_results, split_camera=False, class_average=False, a_or_v=None):
    ...
    print('mots.py: EVAL_MOTS Results before drop:', sum([len(i) for i in before_drop]))
    print('mots.py: EVAL_MOTS Results after drop:', sum([len(i) for i in res]))
